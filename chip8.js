...
var CPU = class {
  ...
  update() {
    ...
    switch (opcode & 61440) {
      case 0:
        return this._handle0({ opcode, hexOrder });
      case 4096:
      ...
      case 32768:
        return this._handle8({ x, y, opcode, hexOrder });
      case 36864:
      ...
      case 57344:
        return this._handleE({ x, opcode, hexOrder });
      case 61440:
        return this._handleF({ x, opcode, hexOrder });
      default:
